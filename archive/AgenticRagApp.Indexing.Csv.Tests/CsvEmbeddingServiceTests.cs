...
public class EmbeddingServiceTests
{
    ...
    private static ChunkStatsAdapter Document(string id, string content, string? summary = null) => new()
    {
        Id      = id,
        Content = content,
        Summary = summary,
    ...
    private static CsvEmbeddingService BuildService(Mock<IEmbeddingClient> embeddingClient, IndexerConfig? config = null) =>
        new(embeddingClient.Object, config ?? Config(), NullLogger<CsvEmbeddingService>.Instance);

# ===========================================================================
# COMMENTED OUT 2026-08-21 - every output here read off the sandbox resources
# in ai_project.tf / ai_sandbox.tf, which are commented out; a reference to a
# commented-out resource fails terraform validate, so these could not stay.
#
# This leaves the root module with no outputs at all, which is valid. Nothing
# consumes them - the pipelines read endpoints from app settings, not from
# terraform output.
# ===========================================================================

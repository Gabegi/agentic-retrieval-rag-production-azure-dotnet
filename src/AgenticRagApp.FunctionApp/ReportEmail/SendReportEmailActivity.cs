...
public class SendReportEmailActivity
{
    ...
    // budget it goes to a blob and is linked instead - the size cap outlived the ACS sender it
    // was set for (10 MB per request, ~7.5 MB after base64) and still bounds what any future

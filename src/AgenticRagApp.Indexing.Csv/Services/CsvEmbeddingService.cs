...
public class CsvEmbeddingService : ICsvEmbeddingService
{
    private readonly IEmbeddingClient          _embeddingClient;
    private readonly IndexerConfig             _config;
    private readonly ILogger<CsvEmbeddingService> _logger;
    ...
    public CsvEmbeddingService(
        IEmbeddingClient                              embeddingClient,
        IndexerConfig                                 config,
        ILogger<CsvEmbeddingService>                     logger)
    {
    ...
    public async Task<CsvEmbeddingRunResult> EmbedDocumentsAsync(
        ...
        CancellationToken ct = default)
    {
        ...
        return new CsvEmbeddingRunResult(
    ...
    private async Task<BatchResult> EmbedBatchAsync(
        IReadOnlyList<ChunkStatsAdapter> batch, SemaphoreSlim semaphore, CancellationToken ct)
    {
    ...
    private record EmbedChunkResult(ChunkStatsAdapter Document, bool Truncated, bool DimError);

...
// AgenticRagApp.Indexing.Pdf.Utils.ChunkingHelper.EstimateTokens), using the measured
// per-segment ratio (docs/2608/260811/tokenizer-redo-findings.md) rather than one blended
// number - the ratio isn't constant (prose ~3.1-3.3 vs table ~2.2-2.9 chars/token), so it

...
namespace AgenticRagApp.Indexing.Pdf.Services
{
    ...
    internal static class PdfNativeMetadataExtractor
    {
        ...
        // ExtractionWarning shape, which is what PdfStepDiagnostics stores.
        ...
        private sealed class PdfDiagnostics
        {
            ...
            public List<ExtractionWarning> Infos    { get; } = [];
            ...
            public void Warn(string message) =>
                Warnings.Add(new ExtractionWarning(RowNumber: null, DocumentId: _blobName, Message: message));

            public void Info(string message) =>
                Infos.Add(new ExtractionWarning(RowNumber: null, DocumentId: _blobName, Message: message));
        }
            ...
            PdfDocument pdf, string blobName, ILogger logger, out PdfStepDiagnostics diagnostics)
        {
            using (pdf)
            {
                ...
                var formFields    = TryGetFormFields(pdf, blobName, logger, diag);
        ...
        // container.
        private static string? AltContainerValue(XElement? element)
        {
